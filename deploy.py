...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('./yolov5', 'custom', source ='local', path='last.pt',force_reload=True,device="cpu") ### The repo is stored locally
...
main(img_path="test_images\\pic2-3320.jpg")
